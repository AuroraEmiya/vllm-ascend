...
#ifndef ASCEND_OPS_STORE_KV_DECODE_COMMON_H
#define ASCEND_OPS_STORE_KV_DECODE_COMMON_H
...
public:
    explicit StoreKVDecodeCommonTiling(gert::TilingContext* context) : context_(context) {};
    virtual ~StoreKVDecodeCommonTiling() = default;
...
protected:
    ...
    StoreKVDecodeParams params;
    StoreKVDecodeTilingData tilingData_;
