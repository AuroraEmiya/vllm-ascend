...
#ifndef ASCEND_OPS_read_kv_cache_COMMON_H
#define ASCEND_OPS_read_kv_cache_COMMON_H
...
BEGIN_TILING_DATA_DEF(ReadKVCacheTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(ReadKVCache,  ReadKVCacheTilingData)


struct  ReadKVCacheParams {
...
class ReadKVCacheCommonTiling {
public:
    explicit ReadKVCacheCommonTiling(gert::TilingContext* context) : context_(context) {};
    virtual ~ReadKVCacheCommonTiling() = default;
...
protected:
    ...
    ReadKVCacheParams params;
    ReadKVCacheTilingData tilingData_;
